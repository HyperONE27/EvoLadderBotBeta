...
Queue-specific views (QueueSetupView, QueueSearchingView, MatchFoundView,
MatchReportView, and their selects) remain in queue_command.py because they
are tightly coupled to queue lifecycle HTTP helpers.
"""

"""
ReplayDetailsEmbed — shown as a standalone message after a replay is uploaded.
...
class ReplayDetailsEmbed:
    ...
    def get_success_embed(
        ...
        """Create the full replay details embed."""
        ...
        embed.add_field(name="🗺️ Map", value=map_display, inline=True)
        ...
        if verification_results:
            verification_text = ReplayDetailsEmbed._format_verification(
    ...
    def _format_verification(results: dict[str, Any], enforcement_enabled: bool) -> str:
        ...
        if obs_check.get("success"):
            ...
            lines.append(
                f"- ❌ **Observers Detected:** Unauthorized observers: `{names}`."
            )
    ...
    def get_error_embed(error_message: str) -> discord.Embed:
        """Create a red error embed for a replay parsing failure."""
        embed = discord.Embed(

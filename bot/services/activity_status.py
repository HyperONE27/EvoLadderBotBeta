...
async def _create_status_message(
    ...
    embed = ActivityStatusEmbed(
        ...
        last_match_at_1v1=None,
        last_match_at_2v2=None,
...
async def _refresh_status_embed_once(client: discord.Client) -> None:
    ...
    embed = ActivityStatusEmbed(
        ...
        last_match_at_1v1=ensure_utc(stats.get("last_match_at_1v1")),
        last_match_at_2v2=ensure_utc(stats.get("last_match_at_2v2")),

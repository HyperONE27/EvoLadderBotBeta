"""
DEPRECATED: /termsofservice command.

This command has been deprecated. Its functionality has been merged into /setup,
which now presents the Terms of Service embed as its first step. Users accept or
decline ToS directly within the /setup flow before proceeding to profile setup.

The module is retained for reference. The command is no longer registered.
"""
